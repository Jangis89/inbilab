...
const TRANSCRIPT_PROMPT = `당신은 영상 대본 추출 전문가입니다. 이 영상을 직접 보고 들으며 실제 내용을 그대로 추출하세요. 절대 창작하거나 요약하지 말고, 들리는/보이는 그대로 옮기세요. 그리고 각 문장을 누가 말하는지(화자)를 구분하세요.
...
아래 JSON 형식으로만 출력하세요:
{
  ...
  "lines": [ { "t": "0:03", "speaker": "화자 이름", "text": "나레이션·대사 한 문장 (들리는 그대로, 시간 순서대로)" } ],
