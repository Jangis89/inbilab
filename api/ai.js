...
- variations(응용 3버전)는 반드시 이 영상과 똑같은 소재·주제를 유지하세요. 소재를 바꾸지 말고 첫 3초를 여는 방식만 바꿉니다. 예: 주제가 "청년 무직 인구 급증"이고 원본 훅이 "지금 대한민국이 역대급 위기인 이유"라면, 같은 주제를 ① 같은 전략으로 더 강하게 ② 다른 전략으로 ③ 또 다른 전략으로 여는 첫 문장을 제안하세요.
- 모든 값은 한국어.
...
JSON만 출력하세요:
{
  ...
  "variations": [
    { "kind": "같은 전략 · 더 강한 버전", "strategy": "전략 이름", "first_line": "이 영상의 주제 그대로, 같은 전략을 더 강하게 다듬은 첫 문장", "first_scene": "첫 화면 설명 한 줄" },
    { "kind": "다른 전략으로 열기 1", "strategy": "다른 전략 이름", "first_line": "이 영상의 주제 그대로, 다른 전략으로 여는 첫 문장", "first_scene": "..." },
    { "kind": "다른 전략으로 열기 2", "strategy": "또 다른 전략 이름", "first_line": "이 영상의 주제 그대로, 또 다른 전략으로 여는 첫 문장", "first_scene": "..." }
  ]
}
